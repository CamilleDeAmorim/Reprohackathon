...
# 2- Usage :
First clone this project in your repository using :
git clone 
...
<img src="Workflow_Diagram/rulegraph.png" alt="Workflow Diagram" style="display: block; margin: auto;" width="300">
